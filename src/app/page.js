...
const App =async () => {
  ...
  return (
    <main className='w-full '>
        <header className='w-full  bg-[url("/images/banner.jpg")]  h-[90vh] bg-cover text-white flex justify-center flex-col items-end relative'>
              ...
              <h1 className='text-4xl lg:text-5xl  2xl:text-8xl w-11/12 lg:max-w-[500px] 2xl:max-w-[900px] font-bold text-end me-7 z-10 '>Style Redefined for the Modern Man</h1>
        ...
        <main className='mt-20 w-10/12 mx-auto'>
            ...
            <section className='grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full mx-auto max-w-[1000px] gap-10 mt-10'>
            {products.map(item=>{
  ...
  <div className="hero-content items-start flex-col lg:flex-row-reverse gap-10">
    ...
    height={1000}
      ...
      className="w-full lg:w-[400px] h-[300px] md:h-full rounded-lg shadow-2xl object-cover" />
